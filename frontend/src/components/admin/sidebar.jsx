...
export default function MainSidebar() {
  const sidebars=useSelector((state)=>state.auth.sidebar)
  console.log("japau",sidebars)
  ...
  return (
    <div className={`col-2 ${sidebars? `d-flex`:`d-none`} d-lg-flex animation-for-the-sidebar`}>
     
    <div
      className="second-sidebar-back position-fixed"
      style={{ height: "100vh" }}
    >
      ...
      <div
        className="side-reviews side-link"
      ...
      <div
        className="side-product side-link"
      ...
      <div
        className="side-product side-link"
        onClick={() => navigate("/Orderslistpage")}
      >
        <span>
          <i class="bi bi-bag"></i>
        </span>
      ...
      <div
        className="side-product side-link"
        onClick={() => navigate("/Userauthuenticationpage")}
      >
        <span>
      ...
      <a
        className="side-Logout side-link"
